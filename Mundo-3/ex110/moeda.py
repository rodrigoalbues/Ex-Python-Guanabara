"""Adicione ao módulo moeda.py criado nos exs anteriores, uma função chamada resumo(), mostre na tela algumas informações geradas pelas funções que já temos no módulo criado até aqui."""
